<template>
<div>
<router-link :to="{name: 'patient'}">Patient</router-link><br>
<router-link :to="{name: 'consultation'}">Consultation</router-link><br>
<router-link :to="{name: 'facture'}">Facture</router-link><br>
